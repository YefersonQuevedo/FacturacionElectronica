...
namespace ExchangeEmailResponse
{
...
namespace UploadDocumentResponse
{
    using System.Runtime.Serialization;
    ...
    public partial class UploadDocumentResponse : object
    {
        ...
        private XmlParamsResponseTrackId.XmlParamsResponseTrackId[] ErrorMessageListField;
        
        private string ZipKeyField;
        
        [System.Runtime.Serialization.DataMemberAttribute()]
        public XmlParamsResponseTrackId.XmlParamsResponseTrackId[] ErrorMessageList
        {
            get
            {
...
namespace XmlParamsResponseTrackId
{
    using System.Runtime.Serialization;
...
namespace NumberRangeResponseList
{
    using System.Runtime.Serialization;
    ...
    public partial class NumberRangeResponseList : object
    {
        ...
        private NumberRangeResponse.NumberRangeResponse[] ResponseListField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public NumberRangeResponse.NumberRangeResponse[] ResponseList
        {
            get
            {
...
[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
[System.ServiceModel.ServiceContractAttribute(Namespace="http://wcf.dian.colombia", ConfigurationName="IWcfDianCustomerServices")]
public interface IWcfDianCustomerServices
{
    ...
    System.Threading.Tasks.Task<ExchangeEmailResponse.ExchangeEmailResponse> GetExchangeEmailsAsync();
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> GetStatusAsync(string trackId);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse[]> GetStatusZipAsync(string trackId);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> GetStatusEventAsync(string trackId);
    ...
    System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendBillAsyncAsync(string fileName, byte[] contentFile);
    ...
    System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendTestSetAsyncAsync(string fileName, byte[] contentFile, string testSetId);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> SendBillSyncAsync(string fileName, byte[] contentFile);
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://wcf.dian.colombia/IWcfDianCustomerServices/SendBillAttachmentAsync", ReplyAction="http://wcf.dian.colombia/IWcfDianCustomerServices/SendBillAttachmentAsyncResponse" +
        "")]
    System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendBillAttachmentAsyncAsync(string fileName, byte[] contentFile);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> SendEventUpdateStatusAsync(byte[] contentFile);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> SendNominaSyncAsync(byte[] contentFile);
    ...
    System.Threading.Tasks.Task<NumberRangeResponseList.NumberRangeResponseList> GetNumberingRangeAsync(string accountCode, string accountCodeT, string softwareCode);
    ...
    System.Threading.Tasks.Task<EventResponse.EventResponse> GetXmlByDocumentKeyAsync(string trackId);
    ...
    System.Threading.Tasks.Task<DianResponse.DianResponse> GetReferenceNotesAsync(string trackId);
}

[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
public interface IWcfDianCustomerServicesChannel : IWcfDianCustomerServices, System.ServiceModel.IClientChannel
{
}

[System.Diagnostics.DebuggerStepThroughAttribute()]
[System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
public partial class WcfDianCustomerServicesClient : System.ServiceModel.ClientBase<IWcfDianCustomerServices>, IWcfDianCustomerServices
{
    ...
    public System.Threading.Tasks.Task<ExchangeEmailResponse.ExchangeEmailResponse> GetExchangeEmailsAsync()
    {
        return base.Channel.GetExchangeEmailsAsync();
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> GetStatusAsync(string trackId)
    {
        return base.Channel.GetStatusAsync(trackId);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse[]> GetStatusZipAsync(string trackId)
    {
        return base.Channel.GetStatusZipAsync(trackId);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> GetStatusEventAsync(string trackId)
    {
        return base.Channel.GetStatusEventAsync(trackId);
    }
    
    public System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendBillAsyncAsync(string fileName, byte[] contentFile)
    {
        return base.Channel.SendBillAsyncAsync(fileName, contentFile);
    }
    
    public System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendTestSetAsyncAsync(string fileName, byte[] contentFile, string testSetId)
    {
        return base.Channel.SendTestSetAsyncAsync(fileName, contentFile, testSetId);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> SendBillSyncAsync(string fileName, byte[] contentFile)
    {
        return base.Channel.SendBillSyncAsync(fileName, contentFile);
    }
    
    public System.Threading.Tasks.Task<UploadDocumentResponse.UploadDocumentResponse> SendBillAttachmentAsyncAsync(string fileName, byte[] contentFile)
    {
        return base.Channel.SendBillAttachmentAsyncAsync(fileName, contentFile);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> SendEventUpdateStatusAsync(byte[] contentFile)
    {
        return base.Channel.SendEventUpdateStatusAsync(contentFile);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> SendNominaSyncAsync(byte[] contentFile)
    {
        return base.Channel.SendNominaSyncAsync(contentFile);
    }
    
    public System.Threading.Tasks.Task<NumberRangeResponseList.NumberRangeResponseList> GetNumberingRangeAsync(string accountCode, string accountCodeT, string softwareCode)
    {
        return base.Channel.GetNumberingRangeAsync(accountCode, accountCodeT, softwareCode);
    }
    
    public System.Threading.Tasks.Task<EventResponse.EventResponse> GetXmlByDocumentKeyAsync(string trackId)
    {
        return base.Channel.GetXmlByDocumentKeyAsync(trackId);
    }
    
    public System.Threading.Tasks.Task<DianResponse.DianResponse> GetReferenceNotesAsync(string trackId)
    {
